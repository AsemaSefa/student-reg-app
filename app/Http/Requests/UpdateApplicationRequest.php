...
class UpdateApplicationRequest extends FormRequest
{
    ...
    public function rules(): array
    {
         return [
            ...
            'email' => 'required|email|max:255|unique:applications,email,' . $this->route('application'),
            'nin' => 'required|string|max:20|unique:applications,nin,' . $this->route('application'),
